...
import { Clock, ChevronLeft, ChevronRight, MapPin, Link as LinkIcon, Loader2, ExternalLink, Calendar, GraduationCap, BookOpen, Info } from 'lucide-react';
...
import { studentScheduleService, type StudentScheduleCalendarItem } from '../../services/studentSchedule.service';
...
export function StudentSchedule() {
  ...
  const fetchSchedules = async () => {
    ...
    try {
      ...
      const response = await studentScheduleService.getStudentScheduleForCalendar(
        user.studentId,
      ...
      if (response.success && response.data) {
        const mappedEvents: ScheduleEvent[] = response.data.map((item: StudentScheduleCalendarItem) => ({
          id: item.scheduleId,
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">View your class and exam schedule for enrolled courses</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="text-sm text-blue-900">
          <span className="font-semibold">Schedule Information:</span> This calendar shows all scheduled events for your enrolled courses with verified payments. Click on any event to view details including location and meeting links.
        </div>
      </div>
      ...
      <Dialog open={showEventDetailDialog} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              View details of your scheduled event
            </DialogDescription>
          </DialogHeader>
