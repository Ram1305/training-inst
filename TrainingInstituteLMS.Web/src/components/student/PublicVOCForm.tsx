...
export function PublicVOCForm({ onBack, onLogin, onAbout, onContact, onBookNow, onForms, onFeesRefund, onGallery, onCourseDetails, onVOC, onViewCourses, onViewComboCourses }: PublicVOCFormProps) {
