        ...
        <CardContent className="pt-6 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-800 text-sm">
              The exam management system will be fully implemented in the next update. All features including exam creation, scheduling, and management will be available shortly.
            </p>
          </div>
        </CardContent>
      </Card>
