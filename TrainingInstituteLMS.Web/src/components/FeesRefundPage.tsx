    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-2xl sm:text-4xl font-bold text-slate-900 mb-6 sm:mb-8">Terms & Conditions</h1>

          {/* Compulsory Fees Section */}
          <section className="mb-8 sm:mb-12">
            <h2 className="text-xl sm:text-2xl font-bold text-blue-900 mb-4 sm:mb-6">COMPULSORY FEES</h2>
          ...
          <section className="mb-8 sm:mb-12">
            <h2 className="text-xl sm:text-2xl font-bold text-blue-900 mb-4 sm:mb-6">REFUND POLICY</h2>
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 space-y-4">
